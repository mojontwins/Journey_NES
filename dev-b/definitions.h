...
// Communications
	...
	#define COMM_STATS_LIVES				(COMM_POOL[0x3])
	#define COMM_STATS_LEVEL				(COMM_POOL[0x4])
	#define COMM_STATS_STATUS				(COMM_POOL[0x5])
...
// Game definitions
	...
	#define MAP_W							5		// Size of the BIGGEST map
	#define MAP_H							5
...
// Propellers
	...
	#define PROPELLERS_PATTERN				0x5d		// Animating patterns start here
	#define PROPELLERS_BIT 					64			// Bit to make a tile "propellable"
	//#define PROPELLERS_LIMIT				5			// max # of tiles high. Comment for no limit
	#define PROPELLERS_CREATE_FROM_MAP		22			// Detect this tile # in the map to create
...
// Estrujators
	...
	#define ESTRUJATORS_TILE 				24			// Detect this tile # in the map to create
...
// Cataracts
	...
	#define CATARACTS_IDLE_TIME				120
	#define CATARACTS_PATTERN 				0x61
	#define CATARACTS_DELETE_PATTERN 		0x62
...
// Expand upon this when needed
	...
	#define SPRITE_EXPLOSION 				ssit_03
	#endif
...
// Music
	...
	#define MUSIC_BOSS						0
	#define MUSIC_INGAME_B 					1
	#define MUSIC_INGAME_C 					2
	#define MUSIC_INGAME_A 					3 
...
// Make code more readable:
	...
	#define FLAG_RANDOM_CONNECTION 			1
	#define FLAG_ESTRUJATORS				2
	#define FLAG_CATARACTS 					4
	#define FLAG_PROPELLERS					8
	#define FLAG_SLOW_FANTYS				16
	#define FLAG_PAL_CYCLE					32
